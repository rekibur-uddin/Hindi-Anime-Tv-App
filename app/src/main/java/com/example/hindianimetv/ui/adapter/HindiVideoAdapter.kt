...
import com.example.hindianimetv.databinding.ItemVideoHomeBinding
import com.example.hindianimetv.util.YoutubeUtils

class HindiVideoAdapter(private val onItemClick: (VideoItem) -> Unit) :
    ListAdapter<VideoItem, HindiVideoAdapter.VH>(DIFF) {
    ...
    inner class VH(val binding: ItemVideoHomeBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        val binding = ItemVideoHomeBinding.inflate(inflater, parent, false)
        return VH(binding)
    }
